...
gage_data <- read.table( # works better with text datasets
  theURL,
...
#results always brought in as strings, so need to convert to numbers

#3 Construct a dataframe from the values

df <- data.frame(states = the_states,
                 price = as.numeric(the_price),
                 capacity = as.numeric(gsub(",","",the_capacity)), # gets rid of commas
