...
```{r create tables, warning=FALSE, echo=FALSE}
knitr::kable(nutrient_data_tn, caption = "Summary Table of Nitrogen")

knitr::kable(nutrient_data_tn, caption = "Another summary table of Nitrogen")
```
