...
temps_F <- c(80,81,83,83,77) # Creating a vector with the high temps for next 5 days

#What is the average of these temperatures 
mean(temps_F) # calculating the average of the vector values

#Compute the difference between each temperature and the average calculated above
difference_F <- c(temps_F - 80.8) # Creating a new vector where the values are vector 1 minus the average value
temps_F - mean(temps_F)

#Subtract 32 and multiply by 5/9ths to create a vector in Celsius
temps_C <- ((temps_F - 32)) * (5/9) # Creating a new vector with temps in celsius
