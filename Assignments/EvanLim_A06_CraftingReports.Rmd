...
```{r, echo=FALSE, warning=FALSE, fig.align='left', fig.width = 8, fig.height = 4, fig.cap="2018 monthly Ozone levels"}
Ozone_2018 <- epa_data %>% 
  filter(Year == "2018") %>% 
  ggplot(
    aes(
...
```{r, echo=FALSE, warning=FALSE, fig.align='left', fig.width = 8, fig.height = 4, fig.cap="2019 monthly Ozone levels"}
Ozone_2019 <- epa_data %>% 
  filter(Year == "2019") %>% 
  ggplot(
    aes(
...
https://github.com/evanlim77/EDE_Fall2025
