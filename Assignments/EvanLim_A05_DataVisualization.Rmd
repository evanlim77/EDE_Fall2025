...
# Setting my theme to the default
...
```{r Create boxplots}
#5 Creating three boxplots and printing them together
...
```{r Plot litter}
#6 Plotting dry mass by date and using NLCD class as color
Niwo.litter <- Niwo %>% 
  filter(
